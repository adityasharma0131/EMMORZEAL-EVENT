...
$pdf->SetTitle('Fine Arts Attendance');
...
// Header text
$headerText = 'Fine Arts Participants';
...
$sql = "SELECT participantName, ccName, contactNumber, subEvent FROM fine_arts";
