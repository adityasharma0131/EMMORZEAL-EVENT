...
$pdf->SetTitle('Literary Arts Participants');
...
// Header text
$headerText = 'Literary Arts Participants';
...
$sql = "SELECT participantName, ccName, contactNumber, subEvent FROM literary_arts";
...
$pdf->Output('literary_arts_participants.pdf', 'I');
?>
