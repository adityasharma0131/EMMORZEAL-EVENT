...
$pdf->SetTitle('Formal Events Attendance');
...
// Header text
$headerText = 'Formal Events Participants';
...
$sql = "SELECT participantName, ccName, contactNumber, subEvent FROM informal_events";
